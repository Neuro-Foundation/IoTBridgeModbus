"C:\Program Files\Microsoft Visual Studio\2022\Professional\MSBuild\Current\Bin\MSBuild.exe" ^
	"C:\My Projects\IoTBridgeModbus\Build\Build.csproj" ^
	-t:BuildSetup ^
...
"C:\My Projects\IoTGateway\Utilities\Waher.Utility.Install\bin\Release\PublishOutput\win-x86\Waher.Utility.Install.exe" ^
	-dk IoTBridgeModbus.Dockerfile ^
	-de IoTBridgeModbus.env ^
...
docker build -f IoTBridgeModbus.Dockerfile -t iot-bridge-modbus:latest .
